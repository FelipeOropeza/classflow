...
<head>
    ...
    <title>Horário de Aulas — {{ $schoolClass->name }}</title>
    <style>
        @page { 
            size: A4 landscape; 
            margin: 15mm; 
...
<body>
    <div class="container">
        <div class="report-header">
            ...
            <h2>Quadro de Horários - Turma: {{ $schoolClass->name }} (Matutino)</h2>
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @php 
                        $p1 = $grid[1][$dayId] ?? null;
                        $p2 = $grid[2][$dayId] ?? null;
                        $p3 = $grid[3][$dayId] ?? null;
                        $p4 = $grid[4][$dayId] ?? null;
                        $p5 = $grid[5][$dayId] ?? null;
                        $p6 = $grid[6][$dayId] ?? null;
                    @endphp
